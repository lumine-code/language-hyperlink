...
// count derived at runtime could never do. The TextMate `hyperlink.json` beside
// it is not a `TreeSitterGrammar` and does not count here.

const PACKAGE_NAME = "language-hyperlink";
